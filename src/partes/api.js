...
const api = {
    ...
    mostrar: (dados, teste, lat, lon) => {
        ...
        // Converti para um array, para permitir a consulta dos dados.
        ...
        atual.innerHTML = array.map((day, id) => {
            if (id === 0) {
                ...
                if (angVento === 0 || angVento === 360) {
                    direcaoVento = "Norte";
                } else if (angVento > 0 && angVento < 90) {
                    direcaoVento = "Nordeste";
                } else if (angVento === 90) {
                    direcaoVento = "Leste";
                } else if (angVento > 90 && angVento < 180) {
                    direcaoVento = "Sudeste";
                } else if (angVento === 180) {
                    direcaoVento = "Sul";
                } else if (angVento > 180 && angVento < 270) {
                    direcaoVento = "Sudoeste";
                } else if (angVento === 270) {
                    direcaoVento = "Oeste";
                } else if (angVento > 270 && angVento < 360) {
                ...
                let dayT = data.substring(0,3);
                let dia;
                let monthT = data.substring(4,7);
                let mes;

                let dayN = data.substring(8,10);
                ...
                let dataTraduzida = dia +" "+ mes +" "+ dayN +" "+ year;

                return (
                // Aqui são mostradas as informações do dia atual.

                    `<div class="data">
                    <p>Hoje - ${dataTraduzida}</p>
                </div>
                ...
                <div class="infos">
                    <div class="imagem">
                        <img src="http://openweathermap.org/img/wn/${icone}@4x.png"></img>
                    </div>
                    ...
                    <div class="temperatura">
                        <article class="temp-atual">${tempAtual}°C</article>
                        <div class="maxmin">
                            <article class="max">
                    ...
                    <div class="vento">
                        Vento: <div class="velocidade">${velVento} m/s</div><div class="direcao"><svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512" style="transform: rotate(${angVento}deg);"><title>Direção</title><path d="M256 48C141.13 48 48 141.13 48 256s93.13 208 208 208 208-93.13 208-208S370.87 48 256 48zm80.09 224L272 208.42V358h-32V208.42L175.91 272l-22.54-22.7L256 147.46 358.63 249.3z"/></svg>${direcaoVento}</div>
                    </div>
        ...
        previsoes.innerHTML = dados.daily.map((day, id) => {
            if (id !== 0 && id <= 5) {
                ...
                `<li>
                    <div class="imagem">
                        <img src="http://openweathermap.org/img/wn/${icone}@2x.png"></img>
                    </div>
                    
                    <div class="temps">
                        <article class="max">${tempMax}°C</article>
                        <article class="min">${tempMin}°C</article>
                    </div>

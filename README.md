...
Na previsão do dia atual, é mostrado a data, o ícone referente ao clima da cidade, temperatura atual, temperatura minima e máxima, velocidade e direção do vento, umidade do ar, visibilidade(não sei se a API está marcando isso corretamente) e pressão atmosférica. 
...
> ### `16/09/22`
> + Adicionada a tradução(para o português) do dia da semana e mês nas datas apresentadas.
> + 
> +
